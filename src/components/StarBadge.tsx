...
import styles from "./StarBadge.module.scss";
...
/** Evenodd star field — opaque fill with star cutouts (same SVG as StarButton). */
function StarBackground({ color, clipId }: StarBackgroundProps) {
  return (
    <svg
      width="100%"
      height="100%"
...
export type StarBadgeProps = {
  ...
  duration?: number;
  lightColor?: string;
  /** Fill color for the evenodd star mask (default: currentColor). */
...
/**
 * Decorative StarButton-style badge — non-interactive.
 * Opaque star-mask surface + perimeter light, no click target.
 */
export function StarBadge({
  ...
  const clipId = `star-badge-clip-${useId().replace(/:/g, "")}`;
  ...
  return (
    ...
    >
      ...
      <span className={styles.border} aria-hidden="true">
        <StarBackground color={backgroundColor} clipId={clipId} />
      </span>
